...
public class TextEventFactory {
    ...
    /**
     * Creates a ClickEvent for viewing a peek session with the given ID
     * @param sessionId The session ID
     * @return ClickEvent instance
     */
    public static ClickEvent viewPeekSession(String sessionId) {
        return runFullCommand("/peek view " + sessionId);
    }

    /**
     * Creates a ClickEvent for navigating to a specific page
     * @param commandPrefix The command prefix (e.g., "/peek manage list")
    ...
    /**
     * Creates a HoverEvent for cancel peek tooltip
     * @return HoverEvent instance
     */
