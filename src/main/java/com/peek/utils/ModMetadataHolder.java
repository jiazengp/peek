...
public class ModMetadataHolder {
    ...
    public static void load() {
        Optional<ModContainer> containerOpt = FabricLoader.getInstance().getModContainer(PeekMod.MOD_ID);
        if (containerOpt.isEmpty()) {
            throw new RuntimeException("Cannot find mod container for 'peek'");
        }
